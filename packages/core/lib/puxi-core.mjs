 ...
 */
// mjs
import { Point, utils, Container, BLEND_MODES, Graphics, Rectangle, Text, TextStyle, extras, Texture, Sprite as Sprite$1, BaseTexture } from 'pixi.js';
...
class Slider extends Widget {
    ...
    initialize() {
        super.initialize();
        const localMousePosition = new Point();
        let startValue = 0;
        let trackSize;
 ...
 * @static
 */
Slider.DEFAULT_TRACK = new Graphics()
    ...
    constructor(options = {}) {
        ...
        if (this.scrollY) {
            super.addChild(new ScrollBar({
                ...
                .setLayoutOptions(new BorderLayoutOptions(LayoutOptions.WRAP_CONTENT, LayoutOptions.FILL_PARENT, BorderLayoutOptions.REGION_RIGHT, ALIGN.RIGHT, ALIGN.CENTER))
                .setBackground(0xff)
